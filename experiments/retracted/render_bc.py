...
from oppdef.learning import bc as BC
from oppdef.control.expert import Expert, palm_ctrl
from oppdef.envs.bimanual import LH_HOME, BASE_HALF


def main():
    z = np.load("results/bc_demos.npz")
    ...
    imageio.mimsave("figures/17_bc_policy.gif", frames, fps=25, loop=0)
