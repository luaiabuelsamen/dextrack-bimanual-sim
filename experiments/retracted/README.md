...
| `opposition_axis.py` | superseded by `python -m oppdef.hands.axis`, which uses collision-derived fingertips, enforces the mimic couplings and records provenance |
