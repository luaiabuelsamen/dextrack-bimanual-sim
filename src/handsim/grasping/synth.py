...
from handsim.grasping.epsilon import grasp_metrics, object_contacts
...
class GraspScene:
    ...
    def __init__(self, hand_key, obj_half, mass=0.05, friction=(1.0, 0.02, 0.001),
        ...
        from handsim.embodiment import make, HANDS
        ...
        from handsim.hands.f5d6 import is_dependent, effort_of
        for pfx in prefixes:
        ...
        from handsim.hands.axis import aperture_pose
