...
from handsim.paths import MENAGERIE
...
def build(hinge_friction=HINGE_FRICTION, base_mass=BASE_MASS, two_handed=True,
    ...
    if tactile:
        ...
        probe = spec.compile()
        from handsim.sensing import add_touch_sensors, fingertip_geoms
...
class BimanualBox:
    ...
    def observer(self, spec=None):
        """An `handsim.sensing.Observer` wired to this env."""
        from handsim.sensing import Observer, FULL
