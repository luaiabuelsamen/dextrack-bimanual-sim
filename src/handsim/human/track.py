...
class ReferenceTracker:
    ...
    def __init__(self, seq, hand="shadow", side="rhand", window=None,
        ...
        if window is None:
            from handsim.human.windows import contact_mask, longest_run, object_tree as _tree
    ...
    def synthesize_grasp(self, k=None, samples=12, rounds=2, seconds=0.4,
        ...
        """
        from handsim.human import grasp as G
        from handsim.human.scene import build as build_scene
...
def grasp_epsilon(sc, obj_bid=None) -> tuple[float, int]:
    ...
    """
    from handsim.grasping.epsilon import wrench_set, epsilon_from_wrenches
...
class BimanualTracker:
    ...
    def __init__(self, seq, hand_r="shadow", hand_l="shadow_left",
        ...
        from handsim.human.scene import build as build_scene, build_bimanual
        from handsim.human.retarget import retarget_sequence, retarget_bimanual
