...
def _add_object(spec, obj: str, obj_static: bool, convex_parts: bool):
    ...
    objects encloses up to 3.5x the true volume -- see handsim.human.decompose.
    """
    from handsim.human.decompose import decompose
...
def _mocap_parent(hand: str):
    ...
    """
    from handsim.embodiment import HANDS, hand_spec
...
def build(hand: str = "shadow", obj: str = "mug", free_base: bool = True,
    ...
    """
    from handsim.embodiment import make
    ...
    # can seed the fit.
    from handsim.hands.specs import derive_flex
...
def build_bimanual(hand_r: str = "shadow", hand_l: str = "shadow_left",
    ...
    """
    from handsim.envs.bimanual import _add_base_dof, BASE_DOF
    from handsim.embodiment import HANDS, hand_spec
