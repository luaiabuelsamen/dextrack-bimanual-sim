...
from handsim.hands.specs import SPECS, load, hand_joints
from handsim.hands.model import (tip_bodies, finger_body_set, mimic_pairs,
...
def main():
    ...
    ap.add_argument("--out", default="legacy/results/opposition_axis.json")
    a = ap.parse_args()
    rows = []
