...
def main(out="legacy/figures/4_best_squeeze_lift.gif", w=600, h=460, stride=3, fps=25):
    ...
    Path("legacy/results/best_trace.json").write_text(json.dumps(trace, indent=2))
