...
if __name__ == "__main__":
    ...
    render(MD.BIM_BOX, None, "legacy/figures/1_donothing_original_spawn.gif",
           "do nothing, ORIGINAL spawn", n=260)
    render(MD.BIM_BOX, np.array(g_orig.rec_ctrl),
           "legacy/figures/2_expert_original_spawn.gif", "scripted expert, ORIGINAL spawn")
    render(FIXED, np.array(g_fix.rec_ctrl),
           "legacy/figures/3_expert_corrected_spawn.gif", "scripted expert, CORRECTED spawn")
